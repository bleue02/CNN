...
# polling: average
class Image_128x128_5x5_max(nn.Module):
    def __init__(self, in_channels=3, num_classes=10):
        super(Image_128x128_5x5_max, self).__init__()
        # Convolutional layers
        self.conv1 = nn.Conv2d(in_channels, 128, 5, padding=2)
        ...
        self.conv4 = nn.Conv2d(512, 1024, 5, padding=2)
        self.bn_conv4 = nn.BatchNorm2d(1024)

        self.conv5 = nn.Conv2d(1024, 1024, 5, padding=2)
    ...
    def conv_layers(self, x):
        x = F.relu(self.bn_conv1(self.conv1(x))) # (128 -5 + 2 x 2) /1 + 1 -> 128
...
if __name__ == '__main__':
    ...
    model = Image_128x128_5x5_max().to(device)
    summary(model, (3, 128, 128))


class Image_128x128_5x5_avg(nn.Module):
    def __init__(self, in_channels=3, num_classes=10):
        super(Image_128x128_5x5_avg, self).__init__()
        # Convolutional layers
        self.conv1 = nn.Conv2d(in_channels, 128, 5, padding=2)
        self.bn_conv1 = nn.BatchNorm2d(128)
...
if __name__ == '__main__':
    ...
    model = Image_128x128_5x5_avg().to(device)
    summary(model, (3, 128, 128))
